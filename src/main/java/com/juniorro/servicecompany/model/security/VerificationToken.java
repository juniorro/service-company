...
public class VerificationToken {
	...
	@JoinColumn(nullable = false, name = "systemUser_id")
	...
	public VerificationToken(String token, SystemUser newcustomer) {
		super();
	}
	...
	public VerificationToken(final SystemUser systemUser, final String token) {
		super();
	...
	public void setSystemUser(final SystemUser systemUser) {
		this.systemUser = systemUser;
	}
